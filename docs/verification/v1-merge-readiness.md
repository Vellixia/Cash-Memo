...
| Default real-stack Playwright gate                                                     | Four-worker `account-deletion` re-login fails under shared auth throttling                                                                                                                                 | **PENDING** |
...
Do not merge on this record. Rerun clean/default browser gate after resolving failure, then complete
Tasks 24–25 and final review. This record does not authorize deployment, production migration, route
