...
description: Read-only gate for implemented scope, checked-task evidence, acceptance,
  and convergence
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: quality-gates:commands/speckit.quality-gates.implementation.md
---
