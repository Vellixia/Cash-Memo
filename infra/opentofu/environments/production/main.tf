...
provider "aws" {
  ...
  default_tags { tags = { "cashmemo:environment" = "production", "cashmemo:managed-by" = "opentofu", "cashmemo:release" = var.release_id } }
}
...
module "network" {
  ...
  public_subnet_cidrs      = ["10.84.0.0/24", "10.84.1.0/24"]
  application_subnet_cidrs = ["10.84.16.0/24", "10.84.17.0/24"]
  database_subnet_cidrs    = ["10.84.32.0/24", "10.84.33.0/24"]
