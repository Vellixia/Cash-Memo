...
vi.mock("../generated/api", () => ({
  useGetMonthlySummary: (params: unknown) => {
    ...
    return {
      data: api.month === "success" ? { data: { month: "2026-08", currencies: [
        { currency: "USD", income: "1200.00", expense: "350.00", net: "850.00", expense_categories: [{ category_id: "food", name: "Food", expense: "350.00" }] },
        { currency: "JPY", income: "5000", expense: "1200", net: "3800", expense_categories: [{ category_id: "travel", name: "Travel", expense: "1200" }] },
      ] } } : api.month === "empty" ? { data: { month: "2026-08", currencies: [] } } : undefined,
      isPending: false,
  ...
  useGetBudgetSummary: () => ({
    data: api.budgets === "success" ? { data: { month: "2026-08", budgets: [{ id: "budget", category_id: "food", currency: "USD", budgeted: "300.00", spent: "350.00", remaining: "-50.00", progress: "116.67" }] } } : undefined,
    isPending: false,
    isError: api.budgets === "error",
    refetch: vi.fn(),
  }),
  useGetRecentTransactions: () => ({
    data: api.recent === "success" ? { data: { items: [{ id: "tx", amount: "18.50", currency: "USD", wallet_id: "wallet", category_id: "food", direction: "expense", note: "Lunch", occurred_at: "2026-08-24T05:00:00Z", deleted_at: null, purge_after: null, recurring_occurrence_id: null }] } } : undefined,
    isPending: false,
...
describe("dashboard", () => {
  beforeEach(() => { api.month = "success"; api.budgets = "success"; api.recent = "success"; api.monthParams.length = 0; });
  ...
  it("keeps authoritative monthly totals and categories separated by currency", async () => {
    ...
    expect(screen.getByText("Food").parentElement?.textContent).toContain("USD 350.00");
